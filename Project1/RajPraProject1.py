...
# requires media and fresh_tomatoes python files in same folder
import media
import fresh_tomatoes

#Defines the attributes of the movies objects that are to be displayed in web page
...
#add the list of movies into an array and pass to freshtomatoes to create html page
